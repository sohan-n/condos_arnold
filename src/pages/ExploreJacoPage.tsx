...
const tabConfig = {
  beaches: [
    allCards.jacoBeach,
    allCards.playaHermosa,  // This appears in beaches, surfing, and restaurants
    allCards.playaBlanca,
    allCards.playaMantas,
    allCards.playaHerradura,
  ],
  surfing: [
    allCards.playaHermosa,  // Reused from beaches
    // Add more surfing-specific cards here
  ],
  restaurants: [
    allCards.playaHermosa,  // Reused from beaches (has restaurant)
    // Add more restaurant cards here
  ],
  nightlife: [
    // Add nightlife cards here
  ],
  activities: [
    // Add activity cards here
  ],
  shopping: [
    // Add shopping cards here
  ],
  transportation: [
    // Add transportation cards here
  ],
  tourGuide: [
    // Add tour guide cards here
  ],
};
